...
| 3.2 |  [Python Mod 4](https://contemporary-physicslab.github.io/FYPLC/main/Course%20files/Notebook%204/Notebook%204%20Scientific%20Computing.html) <br> Numpy <br> safety <br> Demo| Derivative | na |  |
| 3.3 |  [Python Mod 5](https://contemporary-physicslab.github.io/FYPLC/main/Course%20files/Notebook%205/Notebook%205%20Data%20in%20Python.html) <br> Plotten, fitten, data-analyse <br> Uitwerken analyse Paraboolbaan| Chain Rule <br> Product Rule | na |  | P/F |
| 4.1 |  Workshop PL: Constructive Conflict | Linearization <br> Line tangent to graph <br> Differentials <br> Differential as error estimate | na | verplichte aanwezigheid |
| 4.2 |  Python Mod 5 | Implicit Differentiation Line tangent to curve Derivative of inverse | na |  |
| 4.3 |  Python Mod 5| Inverse Trigonometric Functions Hyperbolic Functions | na |  | 
|  |  |  |  |  |
| 6.1 |  Workshop ChatGPT & Orienteren Project | Anti-Derivative <br> Sums <br> Area <br> Definite Integral <br> Fundamental Theorem of Calculus <br> Substitution <br> Integral over symmetric interval | na | verplichte aanwezigheid |
| 6.2 |  [Python Mod 6](https://contemporary-physicslab.github.io/FYPLC/main/Course%20files/Notebook%206/Notebook%206%20Measurement%20uncertainty.html) | Integration By Parts Partial Fractions | na  | MC test, **grade** Pyt mod 1-5|
| 6.3 |  IE-1 data verzameling | Improper Integrals <br> proof with Con | na | | Experiment - verplichte aanwezigheid|
| 7.1 |  Workshop PL: Skills and Culture Map | al | na | verplichte aanwezigheid <br>  Quiz 1C |
| 7.2 |  Python Mod 6 | al | na |  |
| 7.3 |  Data-analyse IE1|  | na | verplichte aanwezigheid|
| 8.1 |  Project Q1 | Complex Numbers <br> Complex Conjugate <br> Polar form | na | | 
| 8.2 |  Verslag | Complex Functions <br> Fundamental Theorem of Algebra | na |  |
| 8.3 |  Verslag| Exponential Growth and Decay <br> First-Order DE <br> Direction field <br> Euler method | na |  |
| 9.1 |  Project Q1 Project disseminatie en reflectie| Separable DE Linear DE | na |  |
| 9.2 |  Peer review | 2nd-order DE with constant coefficients | na |  |
| 9.3 |  Verslag| Inhomogeneous DE Resonance | na | Inleveren vr. 21.30h <br> **grade** |
